...
const (
	BookService_GetAuthor_FullMethodName        = "/author.BookService/GetAuthor"
	BookService_GetListofAuthors_FullMethodName = "/author.BookService/GetListofAuthors"
	BookService_CreateAuthor_FullMethodName     = "/author.BookService/CreateAuthor"
	BookService_UpdateAuthor_FullMethodName     = "/author.BookService/UpdateAuthor"
	BookService_DeleteAuthor_FullMethodName     = "/author.BookService/DeleteAuthor"
)
...
func (c *bookServiceClient) GetAuthor(ctx context.Context, in *GetAuthorRequest, opts ...grpc.CallOption) (*GetAuthorResonse, error) {
	...
	err := c.cc.Invoke(ctx, BookService_GetAuthor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) GetListofAuthors(ctx context.Context, in *GetListOfAuthorsRequest, opts ...grpc.CallOption) (*GetListOfAuthorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookService_GetListofAuthors_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) CreateAuthor(ctx context.Context, in *CreateAuthorRequest, opts ...grpc.CallOption) (*CreateAuthorResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookService_CreateAuthor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) UpdateAuthor(ctx context.Context, in *UpdateAuthorRequest, opts ...grpc.CallOption) (*UpdateAuthorResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookService_UpdateAuthor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) DeleteAuthor(ctx context.Context, in *DeleteAuthorRequest, opts ...grpc.CallOption) (*DeleteAuthorResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookService_DeleteAuthor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_GetListofAuthors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_GetListofAuthors_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
